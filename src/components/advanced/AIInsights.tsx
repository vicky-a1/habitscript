            ...
            <div>
              ...
              <div className="space-y-2">
                {recommendations.promptSuggestions.slice(0, 3).map((suggestion, index) => (
                  <div key={index} className="flex flex-col sm:flex-row sm:items-center gap-3 p-3 bg-card-soft rounded-lg">
                    <span className="text-sm text-primary-dark flex-1 leading-relaxed">{suggestion}</span>
                    <Button 
                      size="sm" 
                      variant="outline"
