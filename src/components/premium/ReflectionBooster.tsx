    ...
    <div className="space-y-6">
      ...
      <Card className="p-6 bg-white text-black">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h3 className="text-xl font-semibold text-black">Reflection Power</h3>
            <p className="text-black text-sm">Unlock boosters with consistent journaling</p>
          </div>
          <div className="flex items-center gap-2">
            <Crown className="w-6 h-6 text-black" />
            <span className="text-2xl font-bold text-black">{Math.round(powerLevel)}</span>
          </div>
        </div>
        <Progress value={powerLevel} className="h-2 bg-gray-200" />
